...
### 大数据组个人周报（2022-10-17~2022-10-21）
...
**2 . 数分–B2C货源、老3C、直播数据拆分**

​		a ) 数分–B2C货源、老3C、直播数据拆分–看板SQL代码修改 —100%

**3 . 播报迭代**

​		a ) 质检红绿灯数据播报 — 100%

  	 b ) 运营-手机供应链数据播报拆分采货侠业务线数据  —100%
...
​       1 .初次接触数仓开发，不能很快的找到需要修改的地方，容易发送遗漏和忽视。原因还是在于对数仓开发的不熟悉，对SQL的分析有误导致的，接下来还需要继续进行长期学习。 
