...
### 大数据组个人周报（2022-10-24~2022-10-28）

**【本周工作】**

**1 .看板迭代-卖场交易-营销补贴-优惠卷使用明细**

​		背景：看板中缺少【平台补贴率】字段，运营每天都需要手动计算，为提升数据分析效率，需增加该字段；

​		a ) 新增平台优惠补贴字段(platform_amt)，平台补贴率(platform_subsidy_rate) —100%

​       b )  数据脚本修改 + 数据验证 — 100%

**2 . B2C商户UID取60天净支付单量**

​		背景：客服按灯项目需要计算商户的投诉率作为判断条件，投诉率=投诉量/当前商户近60天的净支付订单量

​		a ) hive表和mysql表设计开发 — 100%
...
​       1 .在数据被质疑准确性之后，心态好一点，耐心写SQL查，或者向数仓大佬咨询查询平台，分析是否真的有问题，不要太经常怀疑自己，免得被影响太多时间，没准他根本就没有问题。 
